...
public class Enemy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        Vector3 speedDelta = directionToPlayer.normalized * speed * Time.fixedDeltaTime;
        mRigidBody.rotation = Quaternion.LookRotation(directionToPlayer, Vector3.forward);
        mRigidBody.MovePosition(transform.position + speedDelta);
    }
